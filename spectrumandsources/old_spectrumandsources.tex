...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=5.5 in]{./images/swordy_high.png}
\begin{singlespace}
...
\begeq{E_{\mbox{max}}\approx\beta Z e \left(\frac{B}{1\mbox{ $\mu$G}}\right) \left(\frac{R}{1\mbox{ kpc}}\right)\mbox{ EeV}.}
...
\subsubsection{Top Down Models}%exist as the particles that they require are often
